...
export type BuildConfigFile = {
	...
	/**
	 * Copyright. {year} substring is replaced with the current year.
	 * Note: do note use Copyright symbol, use (c) instead for compatibility.
	 * Default: 'Copyright (c) {year} Nextcloud GmbH'
	 */
	copyright: string,
