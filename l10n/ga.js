OC.L10N.register(
    ...
    "Connecting over http:// is not allowed" : "Ní cheadaítear ceangal thar http://",
    "Invalid server address" : "Seoladh freastalaí neamhbhailí",
    "SSL certificate error" : "Earráid teastais SSL",
    ...
    "Warning: potential security risk" : "Rabhadh: riosca slándála féideartha",
    "Connection to {url} is not private." : "Níl an nasc le {url} príobháideach.",
    "Advanced" : "Casta",
    "This server could not prove that it is {url}." : "Ní raibh an freastalaí seo in ann a chruthú gurb é {url} é.",
    "It has untrusted SSL certificate. This might be caused by an attacker intercepting your connection or server misconfiguration." : "Tá teastas SSL neamhiontaofa aige. D’fhéadfadh sé seo a bheith mar thoradh ar ionsaitheoir ag idircheapadh do nasc nó ar mhíchumraíocht an fhreastalaí.",
    "Proceed" : "Lean ar aghaidh",
    "View certificate" : "Féach ar an deimhniú",
    "Cancel" : "Cealaigh",
    "Certificate details" : "Sonraí an deimhnithe",
    "Issued by" : "Eisithe ag",
    "Issued to" : "Eisithe chuig",
    "Validity period" : "Tréimhse bailíochta",
    "Valid from" : "Bailí ó",
    "Valid until" : "Bailí go dtí",
    "Fingerprint" : "Méarlorg",
    "Common name" : "Ainm coitianta",
    "Organizations" : "Eagraíochtaí",
    "Organizational units" : "Aonaid eagraíochtúla",
    "Locality" : "Ceantar",
    "Country" : "Tír",
    ...
    "Launch in background" : "Seoladh sa chúlra",
    "Theme" : "Téama",
    ...
    "Edit zoom" : "Cuir súmáil in eagar",
    "Reset" : "Athshocraigh",
    "Menu" : "Roghchlár",
    "Update" : "Nuashonrú",
    ...
    "Open in a web browser" : "Oscail i mbrabhsálaí gréasáin",
