...
await spinner('[3/4] Copying styles...', async () => {
	try {
		...
		await $`docker cp ${CONTAINER_NAME}:/var/www/nextcloud/apps/theming/fonts/ ${OUTPUT}/apps/theming/`
		...
		await fetchCssToFile(`https://localhost:${PORT}/index.php/apps/theming/theme/light-highcontrast.css?plain=0&v=1`, join(OUTPUT, '/apps/theming/theme/light-highcontrast.css'))
		await fetchCssToFile(`https://localhost:${PORT}/index.php/apps/theming/theme/light-highcontrast.css?plain=1&v=2`, join(OUTPUT, '/apps/theming/theme/light-highcontrast.plain.css'))
		await fetchCssToFile(`https://localhost:${PORT}/index.php/apps/theming/theme/dark-highcontrast.css?plain=0&v=1`, join(OUTPUT, '/apps/theming/theme/dark-highcontrast.css'))
		await fetchCssToFile(`https://localhost:${PORT}/index.php/apps/theming/theme/dark-highcontrast.css?plain=1&v=2`, join(OUTPUT, '/apps/theming/theme/dark-highcontrast.plain.css'))

		await fetchCssToFile(`https://localhost:${PORT}/index.php/apps/theming/theme/opendyslexic.css?plain=0&v=1`, join(OUTPUT, '/apps/theming/theme/opendyslexic.css'))
		...
		reuse.annotations = filterReuseAnnotationsFiles(reuse.annotations, (file) => file.startsWith('core/img')
			...
			|| file.startsWith('apps/theming/fonts/'))
		...
		reuse.annotations.push({
			files: [
				...
				'apps/theming/theme/light-highcontrast.css',
				'apps/theming/theme/light-highcontrast.plain.css',
				'apps/theming/theme/dark-highcontrast.css',
				'apps/theming/theme/dark-highcontrast.plain.css',
				'apps/theming/theme/opendyslexic.css',
			],
